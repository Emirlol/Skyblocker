...
object MimicFilter : ChatPatternListener(".*?(?:Mimic dead!?|Mimic Killed!|\\\$SKYTILS-DUNGEON-SCORE-MIMIC\\$|\\Q" + SkyblockerConfigManager.config.dungeons.mimicMessage.mimicMessage + "\\E)$") {
	public override fun state() = SkyblockerConfigManager.config.chat.hideMimicKill
