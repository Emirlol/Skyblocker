...
enum class DungeonBoss(val floor: Int, val message: String) {
	NONE(-1, ""),
	...
	fun isFloor(floor: Int) = this.floor == floor

	companion object {
        fun fromMessage(message: String) = entries.firstOrNull { it.message == message } ?: NONE
	}
}
