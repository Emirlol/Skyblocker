...
data class MiningLocationLabel(val category: Category, val centerPos: Vec3d) : Renderable {
	...
	internal enum class DwarvenCategory(override val name: String, val location: BlockPos) : Category {
	...
	internal enum class GlaciteCategory(override val name: String, override val color: Int, val locations: Array<BlockPos?>) : Category {
