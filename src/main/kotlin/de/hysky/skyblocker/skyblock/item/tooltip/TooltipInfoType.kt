 ...
 */ @JvmOverloads constructor(private val address: String?, private val dataEnabled: Predicate<GeneralConfig.ItemTooltip>, private val tooltipEnabled: Predicate<GeneralConfig.ItemTooltip>, private val cacheable: Boolean, private val callback: Consumer<JsonObject?>? = null) : Runnable {
	...
	THREE_DAY_AVERAGE("https://hysky.de/api/auctions/lowestbins/average/3day.json", Predicate { itemTooltip: GeneralConfig.ItemTooltip -> itemTooltip.enableAvgBIN || SkyblockerConfigManager.config.uiAndVisuals.searchOverlay.enableAuctionHouse }, Predicate { itemTooltip: GeneralConfig.ItemTooltip -> itemTooltip.enableAvgBIN }, false),
