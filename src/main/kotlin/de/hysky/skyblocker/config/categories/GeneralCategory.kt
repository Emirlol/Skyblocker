...
import de.hysky.skyblocker.config.ConfigUtils.skyblockerBooleanController
import de.hysky.skyblocker.config.SkyblockerConfigManager.config
import de.hysky.skyblocker.config.SkyblockerConfigManager.defaults
...
object GeneralCategory {
	...
	fun CategoryDsl.create() {
		...
		option("enableTips") {
			...
			controller(BooleanControllerBuilder::create) { skyblockerBooleanController() }
		}
		option("acceptReparty") {
			Option.< Boolean > createBuilder ()
				.name(Text.translatable("skyblocker.config.general.acceptReparty"))
				.binding(
					defaults.general.acceptReparty,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.shortcuts.enableShortcuts,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.shortcuts.enableCommandShortcuts,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.shortcuts.enableCommandArgShortcuts,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.quiverWarning.enableQuiverWarning,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.quiverWarning.enableQuiverWarningInDungeons,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.quiverWarning.enableQuiverWarningAfterDungeon,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.itemList.enableItemList,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.itemTooltip.enableNPCPrice,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.enableMotesPrice,
		...
		.option(
			Option.< GeneralConfig . Average > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.avg,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.enableLowestBIN,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.enableBazaarPrice,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.enableObtainedDate,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.enableMuseumInfo,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.enableExoticTooltip,
			...
			Option.< Boolean > createBuilder ()
				...
				.description(
					OptionDescription.of(
						Text.translatable("skyblocker.config.general.itemTooltip.enableAccessoriesHelper.@Tooltip[0]"),
				...
				.binding(
					defaults.general.itemTooltip.enableAccessoriesHelper,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemTooltip.dungeonQuality,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.itemInfoDisplay.attributeShardInfo,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.itemInfoDisplay.itemRarityBackgrounds,
		...
		.controller(ConfigUtils::createBooleanController)
			.build())
		.option(
			Option.< GeneralConfig . RarityBackgroundStyle > createBuilder ()
				...
				.binding(
					defaults.general.itemInfoDisplay.itemRarityBackgroundStyle,
		...
		.option(
			Option.< Float > createBuilder ()
				...
				.binding(
					defaults.general.itemInfoDisplay.itemRarityBackgroundsOpacity,
		...
		group(
			OptionGroup.createBuilder()
				...
				.collapsed(true)
				.option(
					Option.< GeneralConfig . SlotLockStyle > createBuilder ()
						...
						.binding(
							defaults.general.itemProtection.slotLockStyle,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.wikiLookup.enableWikiLookup,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.wikiLookup.officialWiki,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.specialEffects.rareDungeonDropEffects,
			...
			OptionGroup.createBuilder()
				...
				.option(
					Option.< Boolean > createBuilder ()
						...
						.binding(
							defaults.general.hitbox.oldFarmlandHitbox,
		...
		.option(
			Option.< Boolean > createBuilder ()
				...
				.binding(
					defaults.general.hitbox.oldLeverHitbox,
