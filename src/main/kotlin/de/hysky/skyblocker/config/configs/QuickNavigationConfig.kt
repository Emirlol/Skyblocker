...
class QuickNavigationConfig {
	...
	class QuickNavItem(@kotlin.jvm.JvmField @field:SerialEntry var render: Boolean, @field:SerialEntry var itemData: ItemData, @field:SerialEntry var uiTitle: String, @field:SerialEntry var clickEvent: String)

	class ItemData @JvmOverloads constructor(@kotlin.jvm.JvmField @field:SerialEntry var item: Item, @field:SerialEntry var count: Int = 1, @field:SerialEntry var components: String? = "[]") {
		@JvmOverloads
